// bitrock router 0x9F90708cFd5e36C74c14c706b27154dcbb7Ce7d9
...
200
wallet:
["0xe8352D332c43875d3992Fbf2b2625111D4Ff5625","0xb7bAFE9528cFe4dbB5A4d4BC5253c40467E92eB2",true,true]
_rewardToken:
...
["5","3","1","2","2","1","0"]
_feeReceiver:
0xb7bAFE9528cFe4dbB5A4d4BC5253c40467E92eB2
...
contract Token is Context, IERC20, Ownable {
    ...
    address public router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;  // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
                     // address public router = 0x9F90708cFd5e36C74c14c706b27154dcbb7Ce7d9; //bitrocktest. and main net is 0xeeabd314e2eE640B1aca3B27808972B05c7f6A3b
                    //  address public router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //BSC
                     //address public router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // dunno other dev didnt comment
    ...
    constructor (string memory tokenName,
        ...
        require(msg.value >= 0.00000001 ether, "ETH");
        transferEth(_feeReceiver, 0.00000001 ether);
        if(msg.value > 0.00000001 ether) { // transfer excess back
            transferEth(_msgSender(), msg.value.sub(0.00000001 ether));
        }
